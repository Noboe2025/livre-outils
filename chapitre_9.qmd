...
=> ajouter une dimension environnementale = le problème du bilan carbone associé aux serveurs immenses permettant l'usage de l'IA mais sa trop récente apparition ne permettant pas encore de chercher comment limiter l'impact ni de faire une classification claire de l'impact environnemental de chacune des IA qui existent et se créent chaque jour (cf discussion en classe lors du cours sur l'IA)
